              ...
              SizedBox(
                ...
                SizedBox(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Or login with",style: GoogleFonts.montserrat(color: Colors.grey),),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                        children: [
                          Container(
                ...
                SizedBox(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Dont't have an account?",style: GoogleFonts.montserrat(),),
                      Text("Sign up",style: GoogleFonts.montserrat(color: ColorConstant.primaryColor,fontWeight: FontWeight.bold,fontSize: width*0.04),)
                    ],
                  ),
                )
              ],
