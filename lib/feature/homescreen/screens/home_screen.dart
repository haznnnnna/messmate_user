...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int selectPlans = 0;
  List meals = [
    {'image': 'assets/images/meal1.png', 'title': 'Steak'},
    {'image': 'assets/images/meal2.png', 'title': 'Veg Food'},
    {'image': 'assets/images/meal3.png', 'title': 'Meal'}
  ];
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage(ImageConstant.carouselImage),
                            fit: BoxFit.fill),
                      ...
                      return GestureDetector(
                          ...
                          child: TextButton(
                            onPressed: () {
                              setState(() {
                                selectCategory = categories[index]
                                    ['title']; // Update the selected category
                              });
                            },
                              ...
                              shape: RoundedRectangleBorder(
                                ...
                                side:
                                    selectCategory == categories[index]['title']
                                        ...
                                        : BorderSide(
                                            color: ColorConstant
                                                .blackColor, // Border for unselected categories
                                            width: 1,
                                          ),
                              ),
                            ),
                      ...
                      child: GestureDetector(
                        ...
                        child: Stack(children: [
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsets.only(
                                  left: width * 0.08, top: height * 0.12),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        foodItems2[index]['price'],
                                        style: GoogleFonts.montserrat(
                                            fontWeight: FontWeight.w500,
                                            fontSize: 16),
                                      ),
                                      SizedBox(width: width * 0.09),
                                      Text(foodItems2[index]['order'],
                                          style: GoogleFonts.montserrat(
                                              fontWeight: FontWeight.w500,
                                              color: ColorConstant.blue,
                                              fontSize: 16)),
